  ...
  <div class="main-header">
    ...
    <div class="header-user">
      <div class="nav user-menu nav-list">
        ...
        <div class="d-flex align-items-center me-auto" id="header-search">
          <a class="btn btn-menubar me-1" id="toggle_btn" href="javascript:void(0);">
          ...
          <div class="input-group input-group-flat d-inline-flex me-1">
            ...
            <input class="form-control" type="text" placeholder="Search in HRMS">
          ...
          <div class="dropdown crm-dropdown">
            <a class="btn btn-menubar me-1" data-bs-toggle="dropdown" href="#">
            ...
            <div class="dropdown-menu dropdown-lg dropdown-menu-start">
              <div class="card mb-0 border-0 shadow-none">
                ...
                <div class="card-body pb-1">
                  <div class="row">
                    <div class="col-sm-6">
                      <a class="d-flex align-items-center justify-content-between crm-link mb-3 p-2"
                        href="contacts.html">
          ...
          <a class="btn btn-menubar" href="profile-settings.html">
        ...
        <div class="d-flex align-items-center">
          <div class="me-1">
            <a class="btn btn-menubar btnFullscreen" href="#">
              <i class="ti ti-maximize"></i>
            </a>
          </div>
          <div class="dropdown me-1">
            <a class="btn btn-menubar" data-bs-toggle="dropdown" href="#">
          ...
          <div class="me-1">
            <a class="btn btn-menubar position-relative" href="chat.html">
          ...
          <div class="me-1">
            <a class="btn btn-menubar" href="email.html">
          ...
          <div class="notification_item me-1">
            ...
            <div class="dropdown-menu dropdown-menu-end notification-dropdown p-4">
              <div class="d-flex align-items-center justify-content-between border-bottom mb-3 p-0 pb-3">
              ...
              <div class="noti-content">
                <div class="d-flex flex-column">
                  ...
                  <div class="border-bottom mb-3 pb-3">
                    <a class="pb-0" href="activity.html">
                      <div class="d-flex">
                        <span class="avatar avatar-lg me-2 flex-shrink-0">
                      ...
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          <p class="mb-1">New student record <span class="text-dark fw-semibold">
                              George</span>
                            is created by <span class="text-dark fw-semibold">Teressa</span></p>
                          <span>2 hrs ago</span>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div class="mb-3 border-0 pb-0">
                    <a href="activity.html">
                      <div class="d-flex">
                        <span class="avatar avatar-lg me-2 flex-shrink-0">
              ...
              <div class="d-flex p-0">
                <a class="btn btn-light w-100 me-2" href="#">Cancel</a>
                <a class="btn btn-primary w-100" href="activity.html">View All</a>
              </div>
            </div>
          </div>
                ...
                <div class="card-header">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <p class="fs-12 fw-medium mb-0"><a class="__cf_email__"
                          data-cfemail="c0b7a1b2b2a5ae80a5b8a1adb0aca5eea3afad"
