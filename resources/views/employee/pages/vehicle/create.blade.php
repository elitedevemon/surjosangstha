...
@section('content')
  <div class="card">
    <div class="card-body">
      ...
      <form action="{{ route('employee.vehicle.store') }}" method="POST">
        @csrf
        @if ($errors->any())
        ...
        <div class="row">
          <div class="form-group col-md-6 mt-3">
            ...
            <input class="form-control @error('owner_name') is-invalid @enderror" id="owner_name"
              name="owner_name" type="text" value="{{ old('owner_name') }}"
        ...
        <button class="btn btn-primary mt-4" type="submit">Add Vehicle</button>
    </div>
  </div>
@endsection
  ...
  <script>
    $(document).ready(function() {
      $('button[type=submit]').click(function() {
        ...
        $(this).html('Adding vehicle <i class="fas fa-spinner fa-spin"></i>');
