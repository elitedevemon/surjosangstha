        ...
        <div class="form-group mt-3">
          ...
          <select class="@error('branch_id') is_invalid @enderror form-select" id="branch_id" name="branch_id"
            ...
            @forelse ($branches as $branch)
              <option {{ $branch->id === $group->branch_id ? 'selected' : '' }} value="{{ $branch->id }}">{{ $branch->branch_name }}</option>
            @empty
          ...
          <div class="form-group col-md-6 mt-3">
            ...
            <select class="@error('employee_id') is_invalid @enderror form-select" id="employee_id"
              ...
              @forelse ($employees as $employee)
                <option {{ $employee->id === $group->employee_id ? 'selected' : '' }} value="{{ $employee->id }}">{{ $employee->name }}</option>
              @empty
